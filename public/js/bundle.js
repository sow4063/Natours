...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.138485, 34.086154],
    // zoom: 4,
    // interactive: false,
...
var stripe = Stripe('pk_test_51HYsvGCiLJt0ezB3HYGjPtm8fdHD9SXCwoomKd3zLItToQ6sCWQLjsX3JdnGl1m8SZiSZcXSL5xJvyoNHfjrvqCM00UB6zdtjU');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('btn--save-passwor').textContent = 'Updating...';
            ...
            case 7:
              document.querySelector('btn--save-passwor').textContent = 'Save Password';
